...
headers = {
    ...
    "authorization": "Basic Z3JhdGlzZm8uYTQ3OTIwLm1wLXNlcnZpY2UtYWNjb3VudDo5eG1UR3dGRWswaUE2T2xoSEppSXZ6NTBpOG5uV1Y3SA=="
}
...
sheet_id = '16lvbUF2xveet60YaW5RCmzcz9MxK4M5yuQRcb1vp-E0'
...
print("Data has been written to the sheet.")import gspread
from oauth2client.service_account import ServiceAccountCredentials
import requests
import re
import json
